...
class ProjectForm(ModelForm):
    ...
    related_users = SelectMultipleField('Related Users', choices=[], coerce=str)
    roles = SelectMultipleField('Roles', choices=[], coerce=str)
    name = StringField('Name', validators=[DataRequired()])
    description = TextAreaField('Description')
    status = SelectField('Status', choices=[('Planning', 'Planning'), ('Active', 'Active'), ('Complete', 'Complete'), ('Unknown', 'Unknown')])
